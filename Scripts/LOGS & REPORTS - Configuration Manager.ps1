...
<title>ConfigMgr and Windows Update Troubleshooting Report</title>
<style>
:root {
  --bg: #0b1020;
  --panel: #121933;
...
<div class="wrapper">
  <section class="hero">
    <div>
      <h1>ConfigMgr and Windows Update Troubleshooting Report</h1>
      <div class="subtitle">
        Visual status report for the $hostname client machine.<br>
        The report highlights the overall ConfigMgr Client health and possible Windows Update issues of the device and try to help you with the recommended troubleshooting steps.
      </div>
      <div class="kpi-grid">
